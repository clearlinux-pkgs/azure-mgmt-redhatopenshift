...
License  : MIT
Requires: azure-mgmt-redhatopenshift-python = %{version}-%{release}
Requires: azure-mgmt-redhatopenshift-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-redhatopenshift package.
Group: Default
Requires: azure-mgmt-redhatopenshift-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-redhatopenshift package.


%package python3
Summary: python3 components for the azure-mgmt-redhatopenshift package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_redhatopenshift)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-redhatopenshift package.


%prep
%setup -q -n azure-mgmt-redhatopenshift-0.1.0
cd %{_builddir}/azure-mgmt-redhatopenshift-0.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1588793877
